...
import { CONTRACTS_API_LIST } from "../utils/contractsApi";
    ...
    <main className="flex-1 overflow-y-auto">
      <div className="flex-1 overflow-auto px-6 py-8">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-xl font-semibold text-zinc-900">{copy.contractsPage.title}</h2>
          <p className="mt-2 text-sm text-zinc-500">{copy.contractsPage.body}</p>
