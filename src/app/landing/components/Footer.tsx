      ...
      <div className="w-full pb-8">
        ...
        <div className="mt-10 flex flex-col gap-5 px-5 pt-6 sm:flex-row sm:items-center sm:justify-between md:px-8 lg:px-10">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-2 font-mono text-[0.65rem] text-[#8a8378]">
            ...
            <div className="flex gap-1.5">
              {AI_EXPLORE_LINKS.map((ai) => (
                <a
                  ...
                  className="grid h-7 w-7 place-items-center border border-black/10 bg-white text-[#555] transition hover:border-[#1d1d1f] hover:text-[#1d1d1f]"
                >
                  {ai.icon}
                </a>
              ))}
